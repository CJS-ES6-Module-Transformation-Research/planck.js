...
import { math as libcommonMath_mathjs } from "../lib/common/Math";
import { Vec2 as libcommonVec2_Vec2js } from "../lib/common/Vec2";

describe('Math', function() {

  it('Math', function() {
    testutilexpect_expectjs(libcommonMath_mathjs.isFinite(+'NaN')).be(false);
    testutilexpect_expectjs(libcommonMath_mathjs.isFinite(Infinity)).be(false);
    testutilexpect_expectjs(libcommonMath_mathjs.isFinite('0')).be(false);
    testutilexpect_expectjs(libcommonMath_mathjs.isFinite('')).be(false);

    testutilexpect_expectjs(libcommonMath_mathjs.isFinite(1)).be(true);
    testutilexpect_expectjs(libcommonMath_mathjs.isFinite(0)).be(true);
    testutilexpect_expectjs(libcommonMath_mathjs.isFinite(-1)).be(true);
