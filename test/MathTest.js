...
describe('Math', function () {
    ...
    it('Math', function () {
        expect(_Math.math.isFinite(+'NaN')).be(false);
        expect(_Math.math.isFinite(Infinity)).be(false);
        expect(_Math.math.isFinite('0')).be(false);
        expect(_Math.math.isFinite('')).be(false);

        expect(_Math.math.isFinite(1)).be(true);
        expect(_Math.math.isFinite(0)).be(true);
        expect(_Math.math.isFinite(-1)).be(true);
