import ext_expect from "expect.js";
var mod_expect;
var expect = ext_expect;

ext_expect.Assertion.prototype.list = function(obj, stringify) {
  var sfn;
  if (typeof stringify === 'function') {
    ...
    sfn = function(obj) {
      return ext_expect.stringify(obj, false, 1);
    };
  }
  var match = false;
...
ext_expect.Assertion.prototype.near = function(obj, ep) {
  ep = ep || 1e-12;
