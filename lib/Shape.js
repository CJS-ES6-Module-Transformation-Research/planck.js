...
Shape__deserialize = function(data) {
 var clazz = Shape_TYPES[data.type];
 return clazz && Shape__deserialize && Shape__deserialize(data);
};;

Shape_isValid = function(shape) {
 return !!shape;
};;
...
export { Shape_TYPES as TYPES, Shape__deserialize as _deserialize };
var exported_Shape = Shape;
 ...
 */
export { exported_Shape as Shape };
