...
functionObject_clipSegmentToLine = clipSegmentToLine;
...
let exported_PointState = PointState;
 ...
 * @prop {ContactID} id
 */
export { exported_ClipVertex as ClipVertex };

export { functionObject_clipSegmentToLine as clipSegmentToLine };
export { exported_PointState as PointState };
