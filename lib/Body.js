...
var BodyDef = {
  type: staticBody,
  position: _Vec2.default.zero(),
  angle: 0.0,

  linearVelocity: _Vec2.default.zero(),
  angularVelocity: 0.0,
...
function Body(world, def) {
  ...
  def = (0, _options2.default)(def, BodyDef);

  _ASSERT && common.assert(_Vec2.default.isValid(def.position));
  _ASSERT && common.assert(_Vec2.default.isValid(def.linearVelocity));
  _ASSERT && common.assert(_Math2.default.isFinite(def.angle));
  _ASSERT && common.assert(_Math2.default.isFinite(def.angularVelocity));
  _ASSERT && common.assert(_Math2.default.isFinite(def.angularDamping) && def.angularDamping >= 0.0);
  _ASSERT && common.assert(_Math2.default.isFinite(def.linearDamping) && def.linearDamping >= 0.0);
  ...
  this.m_xf = _Transform2.default.identity();
  this.m_xf.p = _Vec2.default.clone(def.position);
  this.m_xf.q.setAngle(def.angle);

  // the swept motion for CCD
  this.m_sweep = new _Sweep2.default();
  this.m_sweep.setTransform(this.m_xf);

  // position and velocity correction
  this.c_velocity = new _Velocity2.default();
  this.c_position = new _Position2.default();

  this.m_force = _Vec2.default.zero();
  this.m_torque = 0.0;

  this.m_linearVelocity = _Vec2.default.clone(def.linearVelocity);
...
Body.prototype.getLinearVelocityFromWorldPoint = function (worldPoint) {
  var localCenter = _Vec2.default.sub(worldPoint, this.m_sweep.c);
  return _Vec2.default.add(this.m_linearVelocity, _Vec2.default.cross(this.m_angularVelocity, localCenter));
};
...
Body.prototype.getInertia = function () {
  return this.m_I + this.m_mass * _Vec2.default.dot(this.m_sweep.localCenter, this.m_sweep.localCenter);
};
...
function MassData() {
  this.mass = 0;
  this.center = _Vec2.default.zero();
  this.I = 0;
}
...
Body.prototype.resetMassData = function () {
  ...
  var localCenter = _Vec2.default.zero();
  for (var f = this.m_fixtureList; f; f = f.m_next) {
    if (f.m_density == 0.0) {
      continue;
    }
  ...
  if (this.m_I > 0.0 && this.m_fixedRotationFlag == false) {
    ...
    this.m_I -= this.m_mass * _Vec2.default.dot(localCenter, localCenter);
  ...
  // Move center of mass.
  var oldCenter = _Vec2.default.clone(this.m_sweep.c);
  this.m_sweep.setLocalCenter(localCenter, this.m_xf);

  // Update center of mass velocity.
  this.m_linearVelocity.add(_Vec2.default.cross(this.m_angularVelocity, _Vec2.default.sub(this.m_sweep.c, oldCenter)));
};
...
Body.prototype.setMassData = function (massData) {
  ...
  if (massData.I > 0.0 && this.m_fixedRotationFlag == false) {
    this.m_I = massData.I - this.m_mass * _Vec2.default.dot(massData.center, massData.center);
    _ASSERT && common.assert(this.m_I > 0.0);
    this.m_invI = 1.0 / this.m_I;
  }
...
Body.prototype.applyForce = function (force, point, wake) {
  ...
  if (this.m_awakeFlag) {
    ...
    this.m_torque += _Vec2.default.cross(_Vec2.default.sub(point, this.m_sweep.c), force);
  }
};
...
Body.prototype.applyLinearImpulse = function (impulse, point, wake) {
  ...
  if (this.m_awakeFlag) {
    ...
    this.m_angularVelocity += this.m_invI * _Vec2.default.cross(_Vec2.default.sub(point, this.m_sweep.c), impulse);
  }
};
...
Body.prototype.createFixture = function (shape, fixdef) {
  ...
  var fixture = new _Fixture2.default(this, shape, fixdef);
...
Body.prototype.getWorldPoint = function (localPoint) {
  return _Transform2.default.mulVec2(this.m_xf, localPoint);
};
...
Body.prototype.getWorldVector = function (localVector) {
  return _Rot2.default.mulVec2(this.m_xf.q, localVector);
};
...
Body.prototype.getLocalPoint = function (worldPoint) {
  return _Transform2.default.mulTVec2(this.m_xf, worldPoint);
};
...
Body.prototype.getLocalVector = function (worldVector) {
  return _Rot2.default.mulTVec2(this.m_xf.q, worldVector);
};
