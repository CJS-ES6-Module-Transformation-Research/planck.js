...
function Body(world, def) {
  ...
  _ASSERT && common.assert((0, _Vec.isValid)(def.position));
  _ASSERT && common.assert((0, _Vec.isValid)(def.linearVelocity));
  _ASSERT && common.assert((0, _Math.isFinite)(def.angle));
  _ASSERT && common.assert((0, _Math.isFinite)(def.angularVelocity));
  _ASSERT && common.assert((0, _Math.isFinite)(def.angularDamping) && def.angularDamping >= 0.0);
  _ASSERT && common.assert((0, _Math.isFinite)(def.linearDamping) && def.linearDamping >= 0.0);
