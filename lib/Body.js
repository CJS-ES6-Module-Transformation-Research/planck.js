...
function Body(world, def) {
  ...
  _ASSERT && common.assert(_Vec.Vec2.isValid(def.position));
  _ASSERT && common.assert(_Vec.Vec2.isValid(def.linearVelocity));
  _ASSERT && common.assert(_Math.math.isFinite(def.angle));
  _ASSERT && common.assert(_Math.math.isFinite(def.angularVelocity));
  _ASSERT && common.assert(_Math.math.isFinite(def.angularDamping) && def.angularDamping >= 0.0);
  _ASSERT && common.assert(_Math.math.isFinite(def.linearDamping) && def.linearDamping >= 0.0);
