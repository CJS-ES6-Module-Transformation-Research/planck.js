import { assert as CircleShape_common } from "../util/common";
import { createjs as CircleShape_create } from "../util/create";
import { math as CircleShape_Math, EPSILON as Mathjs_EPSILON } from "../common/Math";
import { Rot as CircleShape_Rot, mulVec2 as Rotjs_mulVec2 } from "../common/Rot";

import {
  Vec2 as CircleShape_Vec2,
  zero as Vec2js_zero,
...
import { Shape as CircleShape_Shape } from "../Shape";
/*
...
CircleShape._super = CircleShape_Shape;
CircleShape.prototype = CircleShape_create(CircleShape._super.prototype);
...
CircleShape.prototype.getVertex = function(index) {
  _ASSERT && CircleShape_common.assert(index == 0);
  return this.m_p;
}
