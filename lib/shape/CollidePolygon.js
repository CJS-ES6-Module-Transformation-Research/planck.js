...
function PolygonContact(manifold, xfA, fixtureA, indexA, xfB, fixtureB, indexB) {
  _ASSERT && utilcommon_assertjs.assert(fixtureA.getType() == _PolygonShape.PolygonShape.TYPE);
  _ASSERT && utilcommon_assertjs.assert(fixtureB.getType() == _PolygonShape.PolygonShape.TYPE);
