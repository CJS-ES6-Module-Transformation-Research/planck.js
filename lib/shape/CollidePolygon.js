...
function PolygonContact(manifold, xfA, fixtureA, indexA, xfB, fixtureB, indexB) {
  ...
  _ASSERT && common.assert(fixtureB.getType() == _PolygonShape.PolygonShape.TYPE);
...
function CollidePolygons(manifold, polyA, xfA, polyB, xfB) {
  ...
  // Clip to box side 1
  np = Manifold.clipSegmentToLine(clipPoints1, incidentEdge, _Vec.Vec2.neg(tangent), sideOffset1, iv1);
