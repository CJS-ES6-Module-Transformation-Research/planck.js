...
import { Rot as Rot_Rot, mulVec2 as Rotjs_mulVec2, mulT as Rotjs_mulT } from "../common/Rot";
...
Contactjs_addType(PolygonShapejs_TYPE, PolygonShapejs_TYPE, PolygonContact);

function PolygonContact(manifold, xfA, fixtureA, indexA, xfB, fixtureB, indexB) {
  _ASSERT && common_assert(fixtureA.getType() == PolygonShapejs_TYPE);
  _ASSERT && common_assert(fixtureB.getType() == PolygonShapejs_TYPE);
...
function FindIncidentEdge(c, poly1, xf1, edge1, poly2, xf2) {
  ...
  _ASSERT && common_assert(0 <= edge1 && edge1 < poly1.m_count);
