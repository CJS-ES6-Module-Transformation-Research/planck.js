...
function PolygonContact(manifold, xfA, fixtureA, indexA, xfB, fixtureB, indexB) {
  _ASSERT && CollidePolygon_common.assert(fixtureA.getType() == PolygonShapejs_TYPE);
  _ASSERT && CollidePolygon_common.assert(fixtureB.getType() == PolygonShapejs_TYPE);
...
function FindIncidentEdge(c, poly1, xf1, edge1, poly2, xf2) {
  ...
  _ASSERT && CollidePolygon_common.assert(0 <= edge1 && edge1 < poly1.m_count);
