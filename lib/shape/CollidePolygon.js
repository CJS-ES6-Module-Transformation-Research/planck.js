...
function PolygonContact(manifold, xfA, fixtureA, indexA, xfB, fixtureB, indexB) {
  _ASSERT && CollidePolygon_common(fixtureA.getType() == PolygonShape.TYPE);
  _ASSERT && CollidePolygon_common(fixtureB.getType() == PolygonShape.TYPE);
...
function FindIncidentEdge(c, poly1, xf1, edge1, poly2, xf2) {
  ...
  _ASSERT && CollidePolygon_common(0 <= edge1 && edge1 < poly1.m_count);
