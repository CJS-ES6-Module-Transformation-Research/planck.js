...
(0, _Contact.addType)(PolygonShape.TYPE, PolygonShape.TYPE, PolygonContact);

function PolygonContact(manifold, xfA, fixtureA, indexA, xfB, fixtureB, indexB) {
  _ASSERT && _common.assert.assert(fixtureA.getType() == PolygonShape.TYPE);
  _ASSERT && _common.assert.assert(fixtureB.getType() == PolygonShape.TYPE);
...
function FindIncidentEdge(c, poly1, xf1, edge1, poly2, xf2) {
  ...
  _ASSERT && _common.assert.assert(0 <= edge1 && edge1 < poly1.m_count);
...
function CollidePolygons(manifold, polyA, xfA, polyB, xfB) {
  ...
  // Clip to box side 1
  np = Manifold.clipSegmentToLine(clipPoints1, incidentEdge, (0, _Vec.neg)(tangent), sideOffset1, iv1);
