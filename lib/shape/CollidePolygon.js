import { assert as CollidePolygon_assert } from "../util/common";
...
function PolygonContact(manifold, xfA, fixtureA, indexA, xfB, fixtureB, indexB) {
  _ASSERT && CollidePolygon_assert(fixtureA.getType() == PolygonShapejs_TYPE);
  _ASSERT && CollidePolygon_assert(fixtureB.getType() == PolygonShapejs_TYPE);
...
function FindIncidentEdge(c, poly1, xf1, edge1, poly2, xf2) {
  ...
  _ASSERT && CollidePolygon_assert(0 <= edge1 && edge1 < poly1.m_count);
