...
ChainShape._super = _Shape2.default;
ChainShape.prototype = (0, _create2.default)(ChainShape._super.prototype);
...
ChainShape.prototype._createLoop = function (vertices) {
  ...
  for (var i = 1; i < vertices.length; ++i) {
    ...
    _ASSERT && common.assert(_Vec2.default.distanceSquared(v1, v2) > _Settings2.default.linearSlopSquared);
  }
...
ChainShape.prototype.getChildEdge = function (edge, childIndex) {
  ...
  edge.m_type = _EdgeShape2.default.TYPE;
...
ChainShape.prototype.rayCast = function (output, input, xf, childIndex) {
  ...
  var edgeShape = new _EdgeShape2.default(this.getVertex(childIndex), this.getVertex(childIndex + 1));
...
ChainShape.prototype.computeAABB = function (aabb, xf, childIndex) {
  ...
  var v1 = _Transform2.default.mulVec2(xf, this.getVertex(childIndex));
  var v2 = _Transform2.default.mulVec2(xf, this.getVertex(childIndex + 1));
...
ChainShape.prototype.computeMass = function (massData, density) {
  massData.mass = 0.0;
  massData.center = _Vec2.default.neo();
  massData.I = 0.0;
};
