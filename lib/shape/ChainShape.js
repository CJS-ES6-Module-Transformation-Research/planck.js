import { debug as ChainShape_debug } from "../util/common";
...
import {
  ...
  _deserialize as Vec2js__deserialize,
  neo as Vec2js_neo,
...
import { Shape as ChainShape_Shape, TYPES as Shapejs_TYPES } from "../Shape";
...
Shapejs_TYPES[ChainShape.TYPE] = ChainShape;
...
ChainShape._deserialize = function(data) {
  var shape = new ChainShape(data.vertices.map(Vec2js__deserialize), data.isLoop);
  return shape;
};
...
ChainShape.prototype._createLoop = function(vertices) {
  ...
  for (var i = 1; i < vertices.length; ++i) {
    ...
    _ASSERT && common.assert(Vec2js_distanceSquared(v1, v2) > Settingsjs_linearSlopSquared);
  }
