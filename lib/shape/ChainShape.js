...
ChainShape.prototype = (0, _create.create)(ChainShape._super.prototype);
...
ChainShape.prototype._createLoop = function (vertices) {
  ...
  for (var i = 1; i < vertices.length; ++i) {
    ...
    _ASSERT && (0, _common.assert)(_Vec.Vec2.distanceSquared(v1, v2) > _Settings.linearSlopSquared);
  }
 ...
 */
exports.ChainShape = mod_ChainShape;