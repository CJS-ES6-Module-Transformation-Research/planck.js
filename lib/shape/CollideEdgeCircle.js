...
(0, _Contact.addType)(_EdgeShape.EdgeShape.TYPE, CircleShapejs_TYPE, EdgeCircleContact);
...
function EdgeCircleContact(manifold, xfA, fixtureA, indexA, xfB, fixtureB, indexB) {
  _ASSERT && _common.assert.assert(fixtureA.getType() == _EdgeShape.EdgeShape.TYPE);
...
function ChainCircleContact(manifold, xfA, fixtureA, indexA, xfB, fixtureB, indexB) {
  _ASSERT && _common.assert.assert(fixtureA.getType() == ChainShapejs_TYPE);
  _ASSERT && _common.assert.assert(fixtureB.getType() == CircleShapejs_TYPE);
...
function CollideEdgeCircle(manifold, edgeA, xfA, circleB, xfB) {
  ...
  _ASSERT && _common.assert.assert(den > 0.0);
