...
Contactjs_addType(EdgeShape.TYPE, CircleShape.TYPE, EdgeCircleContact);
Contactjs_addType(ChainShape.TYPE, CircleShape.TYPE, ChainCircleContact);

function EdgeCircleContact(manifold, xfA, fixtureA, indexA, xfB, fixtureB,
    indexB) {
  _ASSERT && CollideEdgeCircle_common(fixtureA.getType() == EdgeShape.TYPE);
  _ASSERT && CollideEdgeCircle_common(fixtureB.getType() == CircleShape.TYPE);
...
function ChainCircleContact(manifold, xfA, fixtureA, indexA, xfB, fixtureB,
    indexB) {
  _ASSERT && CollideEdgeCircle_common(fixtureA.getType() == ChainShape.TYPE);
  _ASSERT && CollideEdgeCircle_common(fixtureB.getType() == CircleShape.TYPE);
...
function CollideEdgeCircle(manifold, edgeA, xfA, circleB, xfB) {
  ...
  _ASSERT && CollideEdgeCircle_common(den > 0.0);
