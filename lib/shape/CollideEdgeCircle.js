...
function EdgeCircleContact(manifold, xfA, fixtureA, indexA, xfB, fixtureB, indexB) {
  _ASSERT && utilcommon_assertjs.assert(fixtureA.getType() == _EdgeShape.EdgeShape.TYPE);
  _ASSERT && utilcommon_assertjs.assert(fixtureB.getType() == _CircleShape.CircleShape.TYPE);
...
function ChainCircleContact(manifold, xfA, fixtureA, indexA, xfB, fixtureB, indexB) {
  _ASSERT && utilcommon_assertjs.assert(fixtureA.getType() == _ChainShape.ChainShape.TYPE);
  _ASSERT && utilcommon_assertjs.assert(fixtureB.getType() == _CircleShape.CircleShape.TYPE);
