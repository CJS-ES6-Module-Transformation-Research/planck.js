...
Contact_Contact.addType(EdgeShapejs_TYPE, CircleShapejs_TYPE, EdgeCircleContact);
Contact_Contact.addType(ChainShapejs_TYPE, CircleShapejs_TYPE, ChainCircleContact);

function EdgeCircleContact(manifold, xfA, fixtureA, indexA, xfB, fixtureB,
    indexB) {
  _ASSERT && utilcommon_assert(fixtureA.getType() == EdgeShapejs_TYPE);
...
function ChainCircleContact(manifold, xfA, fixtureA, indexA, xfB, fixtureB,
    indexB) {
  _ASSERT && utilcommon_assert(fixtureA.getType() == ChainShapejs_TYPE);
  _ASSERT && utilcommon_assert(fixtureB.getType() == CircleShapejs_TYPE);
