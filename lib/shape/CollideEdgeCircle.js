...
Contactjs_addType(CollideEdgeCircle_EdgeShape.TYPE, CircleShapejs_TYPE, EdgeCircleContact);
...
function EdgeCircleContact(manifold, xfA, fixtureA, indexA, xfB, fixtureB,
    indexB) {
  _ASSERT && CollideEdgeCircle_common.assert(fixtureA.getType() == CollideEdgeCircle_EdgeShape.TYPE);
