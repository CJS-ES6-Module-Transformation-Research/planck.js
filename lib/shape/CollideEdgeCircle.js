...
function EdgeCircleContact(manifold, xfA, fixtureA, indexA, xfB, fixtureB,
    indexB) {
  _ASSERT && CollideEdgeCircle_common.assert(fixtureA.getType() == EdgeShape.TYPE);
  _ASSERT && CollideEdgeCircle_common.assert(fixtureB.getType() == CircleShape.TYPE);
...
function ChainCircleContact(manifold, xfA, fixtureA, indexA, xfB, fixtureB,
    indexB) {
  _ASSERT && CollideEdgeCircle_common.assert(fixtureA.getType() == ChainShape.TYPE);
  _ASSERT && CollideEdgeCircle_common.assert(fixtureB.getType() == CircleShape.TYPE);
