import { debug as CollideEdgeCircle_debug } from "../util/common";
...
function EdgeCircleContact(manifold, xfA, fixtureA, indexA, xfB, fixtureB,
    indexB) {
  _ASSERT && common.assert(fixtureA.getType() == EdgeShapejs_TYPE);
...
function ChainCircleContact(manifold, xfA, fixtureA, indexA, xfB, fixtureB,
    indexB) {
  _ASSERT && common.assert(fixtureA.getType() == ChainShapejs_TYPE);
  _ASSERT && common.assert(fixtureB.getType() == CircleShapejs_TYPE);
