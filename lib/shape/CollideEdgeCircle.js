import { assert as CollideEdgeCircle_assert } from "../util/common";
...
function EdgeCircleContact(manifold, xfA, fixtureA, indexA, xfB, fixtureB,
    indexB) {
  _ASSERT && CollideEdgeCircle_assert(fixtureA.getType() == EdgeShapejs_TYPE);
  _ASSERT && CollideEdgeCircle_assert(fixtureB.getType() == CircleShapejs_TYPE);
...
function ChainCircleContact(manifold, xfA, fixtureA, indexA, xfB, fixtureB,
    indexB) {
  _ASSERT && CollideEdgeCircle_assert(fixtureA.getType() == ChainShapejs_TYPE);
  _ASSERT && CollideEdgeCircle_assert(fixtureB.getType() == CircleShapejs_TYPE);
...
function CollideEdgeCircle(manifold, edgeA, xfA, circleB, xfB) {
  ...
  _ASSERT && CollideEdgeCircle_assert(den > 0.0);
