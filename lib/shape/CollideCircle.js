...
import { distanceSquared as Vec2js_distanceSquared } from "../common/Vec2";
import { Contact as Contact_Contact } from "../Contact";
import { e_circles as Manifoldjs_e_circles, e_vertex as Manifoldjs_e_vertex } from "../Manifold";
...
Contact_Contact.addType(CircleShapejs_TYPE, CircleShapejs_TYPE, CircleCircleContact);

function CircleCircleContact(manifold, xfA, fixtureA, indexA, xfB, fixtureB, indexB) {
  _ASSERT && utilcommon_assert(fixtureA.getType() == CircleShapejs_TYPE);
