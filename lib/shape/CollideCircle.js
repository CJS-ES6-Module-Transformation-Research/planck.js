import { assert as CollideCircle_common } from "../util/common";
...
function CircleCircleContact(manifold, xfA, fixtureA, indexA, xfB, fixtureB, indexB) {
  _ASSERT && CollideCircle_common.assert(fixtureA.getType() == CircleShapejs_TYPE);
  _ASSERT && CollideCircle_common.assert(fixtureB.getType() == CircleShapejs_TYPE);
