import { createjs as EdgeShape_createjs } from "../util/create";
import { polygonRadius as Settingsjs_polygonRadius } from "../Settings";
import { Shape as EdgeShape_Shape, TYPES as Shapejs_TYPES } from "../Shape";
import { Transform as EdgeShape_Transform, mulVec2 as Transformjs_mulVec2 } from "../common/Transform";
import { Rot as EdgeShape_Rot, mulVec2 as Rotjs_mulVec2, mulTVec2 as Rotjs_mulTVec2 } from "../common/Rot";

import {
  Vec2 as EdgeShape_Vec2,
  zero as Vec2js_zero,
  neo as Vec2js_neo,
...
EdgeShape._super = EdgeShape_Shape;
EdgeShape.prototype = EdgeShape_createjs(EdgeShape._super.prototype);

EdgeShape.TYPE = 'edge';
Shapejs_TYPES[EdgeShape.TYPE] = EdgeShape;
