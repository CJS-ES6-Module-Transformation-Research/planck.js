...
export var _DEBUG = typeof DEBUG === 'undefined' ? false : DEBUG;

export var _ASSERT = typeof ASSERT === 'undefined' ? false : ASSERT;
...
// EPAxis Type
export var e_unknown = -1;

export var e_edgeA = 1;
export var e_edgeB = 2;

// VertexType unused?
export var e_isolated = 0;

export var e_concave = 1;
export var e_convex = 2;
...
// reused
export var edgeAxis = new EPAxis();

export var polygonAxis = new EPAxis();
export var polygonBA = new TempPolygon();
export var rf = new ReferenceFace();
