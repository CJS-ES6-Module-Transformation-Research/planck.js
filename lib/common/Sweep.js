...
function Sweep(c, a) {
  ...
  this.localCenter = _Vec2.default.zero();
  this.c = _Vec2.default.zero();
  this.a = 0;
  this.alpha0 = 0;
  this.c0 = _Vec2.default.zero();
  this.a0 = 0;
}

Sweep.prototype.setTransform = function (xf) {
  var c = _Transform2.default.mulVec2(xf, this.localCenter);
  this.c.set(c);
  this.c0.set(c);
...
Sweep.prototype.getTransform = function (xf, beta) {
  ...
  // shift to origin
  xf.p.sub(_Rot2.default.mulVec2(xf.q, this.localCenter));
};
...
Sweep.prototype.normalize = function () {
  var a0 = _Math2.default.mod(this.a0, -_Math2.default.PI, +_Math2.default.PI);
  this.a -= this.a0 - a0;
  this.a0 = a0;
};
