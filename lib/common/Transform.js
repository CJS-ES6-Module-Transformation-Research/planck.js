...
exports.Transform = exports.Transform_mulTXf = exports.Transform_mulTVec2 = exports.Transform_mulT = exports.Transform_mulVec2 = exports.Transform_identity = undefined;
...
exports.Transform_identity = Transform_identity = function Transform_identity() {
  var obj = Object.create(Transform.prototype);
  obj.p = (0, _Vec.zero)();
...
exports.Transform_mulVec2 = Transform_mulVec2 = function Transform_mulVec2(a, b) {
  _ASSERT && Transform_assert(a);
  _ASSERT && (0, _Vec.assert)(b);
  var x = a.q.c * b.x - a.q.s * b.y + a.p.x;
  var y = a.q.s * b.x + a.q.c * b.y + a.p.y;
...
exports.Transform_mulT = Transform_mulT = function Transform_mulT(a, b) {
  _ASSERT && Transform_assert(a);
  if ("x" in b && "y" in b) {
    _ASSERT && (0, _Vec.assert)(b);
    var px = b.x - a.p.x;
...
exports.Transform_mulTVec2 = Transform_mulTVec2 = function Transform_mulTVec2(a, b) {
  _ASSERT && Transform_assert(a);
  _ASSERT && (0, _Vec.assert)(b);
  var px = b.x - a.p.x;
  var py = b.y - a.p.y;
...
exports.Transform_mulTXf = Transform_mulTXf = function Transform_mulTXf(a, b) {
  _ASSERT && Transform_assert(a);
  _ASSERT && Transform_assert(b);
  // v2 = A.q' * (B.q * v1 + B.p - A.p)
  // = A.q' * B.q * v1 + A.q' * (B.p - A.p)
...
exports.Transform_identity = Transform_identity;
exports.Transform_mulVec2 = Transform_mulVec2;
exports.Transform_mulT = Transform_mulT;
exports.Transform_mulTVec2 = Transform_mulTVec2;
exports.Transform_mulTXf = Transform_mulTXf;
