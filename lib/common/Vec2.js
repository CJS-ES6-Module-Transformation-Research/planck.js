import { assert as Vec2_common } from "../util/common";
...
Vec2_addCross = function(a, v, w) {
  ...
  _ASSERT && Vec2_common.assert(false);
};
...
export { Vec2_zero, Vec2_neo, Vec2_clone, Vec2_isValid, Vec2_assert, Vec2_lengthSquared, Vec2_distance, Vec2_distanceSquared, Vec2_areEqual, Vec2_skew, Vec2_dot, Vec2_cross, Vec2_addCross, Vec2_add, Vec2_combine, Vec2_sub, Vec2_mul, Vec2_neg, Vec2_abs, Vec2_mid, Vec2_clamp };
