...
_Mat22_isValid = function Mat22_isValid(o) {
  return o && _Mat22_isValid(o.ex) && _Mat22_isValid(o.ey);
};;
 ...
 */
_Mat22_mul = function Mat22_mul(mx, v) {
  if (v && "x" in v && "y" in v) {
    _ASSERT && Mat22_assert(v);
    ...
    // Mat22
    _ASSERT && Mat22_assert(v);
    return new Mat22(_Mat22_mul(mx, v.ex), _Mat22_mul(mx, v.ey));
  }
...
_Mat22_abs = function Mat22_abs(mx) {
  _ASSERT && Mat22_assert(mx);
  return new Mat22(_Mat22_abs(mx.ex), _Mat22_abs(mx.ey));
};;

_Mat22_add = function Mat22_add(mx1, mx2) {
  _ASSERT && Mat22_assert(mx1);
  _ASSERT && Mat22_assert(mx2);
  return new Mat22(_Mat22_add(mx1.ex + mx2.ex), _Mat22_add(mx1.ey + mx2.ey));
};;
