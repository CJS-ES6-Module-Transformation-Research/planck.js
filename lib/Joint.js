import { assert as Joint_common } from "./util/common";
/*
...
function Joint(def, bodyA, bodyB) {
  ...
  _ASSERT && Joint_common.assert(bodyA);
  _ASSERT && Joint_common.assert(bodyB);
  _ASSERT && Joint_common.assert(bodyA != bodyB);
