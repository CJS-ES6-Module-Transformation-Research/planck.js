import { assert as Distance_common } from "../util/common";
import { toString as Distance_stats } from "../common/stats";
import { math as Distance_Math, EPSILON as Mathjs_EPSILON } from "../common/Math";

import {
  Vec2 as Distance_Vec2,
  zero as Vec2js_zero,
...
import { Rot as Distance_Rot, mulTVec2 as Rotjs_mulTVec2 } from "../common/Rot";
import { Sweep as Distance_Sweep } from "../common/Sweep";
import { Transform as Distance_Transform, mulVec2 as Transformjs_mulVec2 } from "../common/Transform";
/*
...
Distance_stats.gjkCalls = 0;
Distance_stats.gjkIters = 0;
Distance_stats.gjkMaxIters = 0;
...
function Distance(output, cache, input) {
  ...
  Distance_stats.gjkMaxIters = Math.max(Distance_stats.gjkMaxIters, iter);
...
DistanceProxy.prototype.getVertex = function(index) {
  _ASSERT && Distance_common.assert(0 <= index && index < this.m_count);
...
DistanceProxy.prototype.set = function(shape, index) {
  ...
  _ASSERT && Distance_common.assert(typeof shape.computeDistanceProxy === 'function');
...
Simplex.prototype.readCache = function(cache, proxyA, transformA, proxyB, transformB) {
  _ASSERT && Distance_common.assert(cache.count <= 3);
...
Simplex.prototype.getSearchDirection = function() {
  ...
  default:
    _ASSERT && Distance_common.assert(false);
    return Vec2js_zero();
  }
}
 ...
 */
export { exported_Distance as Distance };