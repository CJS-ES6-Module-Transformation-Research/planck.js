...
import { assert as Distance_assert } from "../util/common";
import { toString as Distance_toString } from "../common/stats";
...
DistanceProxy.prototype.getVertex = function(index) {
  _ASSERT && Distance_assert(0 <= index && index < this.m_count);
...
DistanceProxy.prototype.set = function(shape, index) {
  ...
  _ASSERT && Distance_assert(typeof shape.computeDistanceProxy === 'function');
...
Simplex.prototype.readCache = function(cache, proxyA, transformA, proxyB, transformB) {
  _ASSERT && Distance_assert(cache.count <= 3);
