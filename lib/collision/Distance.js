...
statsBinding.gjkCalls = 0;
statsBinding.gjkIters = 0;
statsBinding.gjkMaxIters = 0;
...
function Distance(output, cache, input) {
  ...
  statsBinding.gjkMaxIters = Math.max(statsBinding.gjkMaxIters, iter);
