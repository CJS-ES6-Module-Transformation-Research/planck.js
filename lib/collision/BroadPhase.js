import { assert as BroadPhase_common } from "../util/common";
import { math as BroadPhase_Math } from "../common/Math";

import {
  AABB as BroadPhase_AABB,
  isValid as AABBjs_isValid,
  testOverlap as AABBjs_testOverlap,
} from "./AABB";

import { DynamicTree as BroadPhase_DynamicTree } from "./DynamicTree";
/*
...
function BroadPhase() {
  this.m_tree = new BroadPhase_DynamicTree();
  this.m_proxyCount = 0;
  this.m_moveBuffer = [];
...
BroadPhase.prototype.testOverlap = function(proxyIdA, proxyIdB) {
  ...
  return AABBjs_testOverlap(aabbA, aabbB);
}
...
BroadPhase.prototype.createProxy = function(aabb, userData) {
  _ASSERT && BroadPhase_common.assert(AABBjs_isValid(aabb));
...
BroadPhase.prototype.updatePairs = function(addPairCallback) {
  _ASSERT && BroadPhase_common.assert(typeof addPairCallback === 'function');
