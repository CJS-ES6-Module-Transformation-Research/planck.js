import { assert as BroadPhase_assert } from "../util/common";
...
BroadPhase.prototype.createProxy = function(aabb, userData) {
  _ASSERT && BroadPhase_assert(AABBjs_isValid(aabb));
...
BroadPhase.prototype.updatePairs = function(addPairCallback) {
  _ASSERT && BroadPhase_assert(typeof addPairCallback === 'function');
