 ...
 */
function BroadPhase() {
  this.m_tree = new _DynamicTree2.default();
  this.m_proxyCount = 0;
  this.m_moveBuffer = [];
...
BroadPhase.prototype.testOverlap = function (proxyIdA, proxyIdB) {
  ...
  return _AABB2.default.testOverlap(aabbA, aabbB);
};
...
BroadPhase.prototype.queryCallback = function (proxyId) {
  ...
  var proxyIdA = _Math2.default.min(proxyId, this.m_queryProxyId);
  var proxyIdB = _Math2.default.max(proxyId, this.m_queryProxyId);
