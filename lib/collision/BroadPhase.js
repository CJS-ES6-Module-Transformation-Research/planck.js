...
var _DynamicTree = require("./DynamicTree");
...
function BroadPhase() {
  this.m_tree = new _DynamicTree.DynamicTree();
  this.m_proxyCount = 0;
  this.m_moveBuffer = [];
...
BroadPhase.prototype.testOverlap = function (proxyIdA, proxyIdB) {
  ...
  return _AABB.AABB.testOverlap(aabbA, aabbB);
};
...
BroadPhase.prototype.queryCallback = function (proxyId) {
  ...
  var proxyIdA = _Math.math.min(proxyId, this.m_queryProxyId);
  var proxyIdB = _Math.math.max(proxyId, this.m_queryProxyId);
 ...
 */
exports.BroadPhase = BroadPhase_BroadPhase;