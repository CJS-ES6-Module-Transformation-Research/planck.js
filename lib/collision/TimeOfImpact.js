...
// FIXME: discard unused imports
import { debug as TimeOfImpact_debug } from "../util/common";
// FIXME: rename to Timer_now
import { now as TimeOfImpact_now } from "../util/Timer";
import { toString as TimeOfImpact_toString } from "../common/stats";

import {
  // FIXME: don't import unused objects
  Vec2 as TimeOfImpact_Vec2,
  // FIXME: rename to Vec2_zero, do the same for all imported elements
  zero as Vec2js_zero,
  dot as Vec2js_dot,
...
// FIXME: Keep original names for cohesive object imports
import { Sweep as TimeOfImpact_Sweep } from "../common/Sweep";

import {
  // FIXME: unused cohesive object import, in case of used import see above comment
