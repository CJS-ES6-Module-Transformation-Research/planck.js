...
function TimeOfImpact(output, input) {
  ...
  for (;;) {
    ...
    for (;;) {
      ...
      TimeOfImpact_stats = Math.max(TimeOfImpact_stats, rootIterCount);
  ...
  TimeOfImpact_stats = Math.max(TimeOfImpact_stats, iter);

  var time = TimeOfImpact_Timer(timer);
  TimeOfImpact_stats = Math.max(TimeOfImpact_stats, time);
  TimeOfImpact_stats += time;
}
