...
var DistanceInput = TimeOfImpact_Distance.Input;
var DistanceOutput = TimeOfImpact_Distance.Output;
var DistanceProxy = TimeOfImpact_Distance.Proxy;
var SimplexCache = TimeOfImpact_Distance.Cache;
...
function TOIInput() {
  ...
  this.sweepA = new TimeOfImpact_Sweep();
  this.sweepB = new TimeOfImpact_Sweep();
  this.tMax;
}
...
function TimeOfImpact(output, input) {
  var timer = TimeOfImpact_Timer.now();

  ++TimeOfImpact_stats.toiCalls;
  ...
  _ASSERT && TimeOfImpact_common.assert(target > tolerance);
  ...
  for (;;) {
    ...
    TimeOfImpact_Distance(distanceOutput, cache, distanceInput);
    ...
    for (;;) {
      ...
      for (;;) {
        ...
        ++rootIterCount;
        ++TimeOfImpact_stats.toiRootIters;
      ...
      TimeOfImpact_stats.toiMaxRootIters = Math.max(TimeOfImpact_stats.toiMaxRootIters, rootIterCount);
  ...
  TimeOfImpact_stats.toiMaxIters = Math.max(TimeOfImpact_stats.toiMaxIters, iter);

  var time = TimeOfImpact_Timer.diff(timer);
  TimeOfImpact_stats.toiMaxTime = Math.max(TimeOfImpact_stats.toiMaxTime, time);
...
SeparationFunction.prototype.initialize = function(cache, proxyA, sweepA, proxyB, sweepB, t1) {
  ...
  _ASSERT && TimeOfImpact_common.assert(0 < count && count < 3);
...
SeparationFunction.prototype.compute = function(find, t) {
  ...
  default:
    _ASSERT && TimeOfImpact_common.assert(false);
    if (find) {
      this.indexA = -1;
      this.indexB = -1;
    }
...
export { TimeOfImpact_Input as Input, TimeOfImpact_Output as Output };
