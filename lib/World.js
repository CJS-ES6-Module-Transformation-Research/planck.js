...
function World(def) {
  ...
  if (def && _Vec2.default.isValid(def)) {
    def = { gravity: def };
  }

  def = (0, _options2.default)(def, WorldDef);

  this.m_solver = new _Solver2.default(this);

  this.m_broadPhase = new _BroadPhase2.default();
  ...
  this.m_gravity = _Vec2.default.clone(def.gravity);
...
World.prototype.rayCast = function (point1, point2, reportFixtureCallback) {
  ...
  this.m_broadPhase.rayCast({
    ...
    if (hit) {
      ...
      var point = _Vec2.default.add(_Vec2.default.mul(1.0 - fraction, input.p1), _Vec2.default.mul(fraction, input.p2));
...
World.prototype.createBody = function (def, angle) {
  ...
  var body = new _Body2.default(this, def);
...
World.prototype.createDynamicBody = function (def, angle) {
  if (!def) {
    def = {};
  } else if (_Vec2.default.isValid(def)) {
...
var s_step = new _Solver2.default.TimeStep(); // reuse
...
World.prototype.createContact = function (proxyA, proxyB) {
  ...
  // Call the factory.
  var contact = _Contact2.default.create(fixtureA, indexA, fixtureB, indexB);
  if (contact == null) {
    return;
  }
...
World.prototype.destroyContact = function (contact) {
  _Contact2.default.destroy(contact, this);
