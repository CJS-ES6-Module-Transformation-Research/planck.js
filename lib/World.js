...
World.prototype.rayCast = function (point1, point2, reportFixtureCallback) {
  _ASSERT && (0, _common.assert)(typeof reportFixtureCallback === 'function');
  var broadPhase = this.m_broadPhase;
...
World.prototype.shiftOrigin = function (newOrigin) {
  _ASSERT && (0, _common.assert)(this.m_locked == false);
  if (this.m_locked) {
    return;
  }
...
World.prototype.createBody = function (def, angle) {
  _ASSERT && (0, _common.assert)(this.isLocked() == false);
  if (this.isLocked()) {
    return null;
  }
...
World.prototype.destroyBody = function (b) {
  _ASSERT && (0, _common.assert)(this.m_bodyCount > 0);
  _ASSERT && (0, _common.assert)(this.isLocked() == false);
  if (this.isLocked()) {
    return;
  }
...
World.prototype.createJoint = function (joint) {
  _ASSERT && (0, _common.assert)(!!joint.m_bodyA);
  _ASSERT && (0, _common.assert)(!!joint.m_bodyB);
  _ASSERT && (0, _common.assert)(this.isLocked() == false);
  if (this.isLocked()) {
    return null;
  }
...
World.prototype.destroyJoint = function (joint) {
  ...
  _ASSERT && (0, _common.assert)(this.m_jointCount > 0);
  --this.m_jointCount;
