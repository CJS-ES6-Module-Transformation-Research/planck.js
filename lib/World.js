...
World.prototype.queryAABB = function(aabb, queryCallback) {
  _ASSERT && World_common(typeof queryCallback === 'function');
...
World.prototype.rayCast = function(point1, point2, reportFixtureCallback) {
  _ASSERT && World_common(typeof reportFixtureCallback === 'function');
  var broadPhase = this.m_broadPhase;
...
World.prototype.shiftOrigin = function(newOrigin) {
  _ASSERT && World_common(this.m_locked == false);
  if (this.m_locked) {
    return;
  }
...
World.prototype.createBody = function(def, angle) {
  _ASSERT && World_common(this.isLocked() == false);
  if (this.isLocked()) {
    return null;
  }
...
World.prototype.destroyBody = function(b) {
  _ASSERT && World_common(this.m_bodyCount > 0);
  _ASSERT && World_common(this.isLocked() == false);
  if (this.isLocked()) {
    return;
  }
...
World.prototype.createJoint = function(joint) {
  _ASSERT && World_common(!!joint.m_bodyA);
  _ASSERT && World_common(!!joint.m_bodyB);
  _ASSERT && World_common(this.isLocked() == false);
  if (this.isLocked()) {
    return null;
  }
...
World.prototype.destroyJoint = function(joint) {
  ...
  _ASSERT && World_common(this.m_jointCount > 0);
  --this.m_jointCount;
