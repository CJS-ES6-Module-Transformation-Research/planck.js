...
import { BroadPhase as BroadPhase_BroadPhase } from "./collision/BroadPhase";
import { Solver as Solver_Solver, TimeStep as Solverjs_TimeStep } from "./Solver";
...
function World(def) {
  ...
  def = options_options(def, WorldDef);

  this.m_solver = new Solver_Solver(this);

  this.m_broadPhase = new BroadPhase_BroadPhase();
