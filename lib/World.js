...
import { Solver as Solver_Solverjs, TimeStep as Solverjs_TimeStep } from "./Solver";
...
World.prototype.rayCast = function(point1, point2, reportFixtureCallback) {
  _ASSERT && utilcommon_assertjs(typeof reportFixtureCallback === 'function');
  var broadPhase = this.m_broadPhase;
...
World.prototype.shiftOrigin = function(newOrigin) {
  _ASSERT && utilcommon_assertjs(this.m_locked == false);
  if (this.m_locked) {
    return;
  }
...
World.prototype.createBody = function(def, angle) {
  _ASSERT && utilcommon_assertjs(this.isLocked() == false);
  if (this.isLocked()) {
    return null;
  }
...
World.prototype.destroyBody = function(b) {
  _ASSERT && utilcommon_assertjs(this.m_bodyCount > 0);
  _ASSERT && utilcommon_assertjs(this.isLocked() == false);
  if (this.isLocked()) {
    return;
  }
...
World.prototype.createJoint = function(joint) {
  _ASSERT && utilcommon_assertjs(!!joint.m_bodyA);
  _ASSERT && utilcommon_assertjs(!!joint.m_bodyB);
  _ASSERT && utilcommon_assertjs(this.isLocked() == false);
  if (this.isLocked()) {
    return null;
  }
...
World.prototype.destroyJoint = function(joint) {
  ...
  _ASSERT && utilcommon_assertjs(this.m_jointCount > 0);
  --this.m_jointCount;
