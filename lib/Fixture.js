import { assert as Fixture_assert } from "./util/common";
...
Fixture.prototype.setDensity = function(density) {
  _ASSERT && Fixture_assert(Mathjs_isFinite(density) && density >= 0.0);
...
Fixture.prototype.getAABB = function(childIndex) {
  _ASSERT && Fixture_assert(0 <= childIndex && childIndex < this.m_proxyCount);
...
Fixture.prototype.createProxies = function(broadPhase, xf) {
  _ASSERT && Fixture_assert(this.m_proxyCount == 0);
