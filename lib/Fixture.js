...
Fixture.prototype.setDensity = function (density) {
  _ASSERT && (0, _common.assert)((0, _Math.isFinite)(density) && density >= 0.0);
...
Fixture.prototype.getAABB = function (childIndex) {
  _ASSERT && (0, _common.assert)(0 <= childIndex && childIndex < this.m_proxyCount);
...
Fixture.prototype.createProxies = function (broadPhase, xf) {
  _ASSERT && (0, _common.assert)(this.m_proxyCount == 0);
