import { debug as Fixture_debug } from "./util/common";
import { optionsjs as Fixture_optionsjs } from "./util/options";
...
import { Shape as Fixture_Shape, _deserialize as Shapejs__deserialize } from "./Shape";
/*
...
function Fixture(body, shape, def) {
  ...
  def = Fixture_optionsjs(def, FixtureDef);
...
Fixture._deserialize = function(body, data) {
  var shape = Shapejs__deserialize(data.shape);
...
Fixture.prototype.setDensity = function(density) {
  _ASSERT && common.assert(Mathjs_isFinite(density) && density >= 0.0);
