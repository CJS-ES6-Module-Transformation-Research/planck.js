...
Fixture.prototype.setDensity = function(density) {
  _ASSERT && Fixture_common(Mathjs_isFinite(density) && density >= 0.0);
...
Fixture.prototype.getAABB = function(childIndex) {
  _ASSERT && Fixture_common(0 <= childIndex && childIndex < this.m_proxyCount);
...
Fixture.prototype.createProxies = function(broadPhase, xf) {
  _ASSERT && Fixture_common(this.m_proxyCount == 0);
