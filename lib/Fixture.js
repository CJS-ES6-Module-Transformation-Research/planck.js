...
import { Vec2 as Vec2_Vec2, sub as Vec2js_sub } from "./common/Vec2";
...
function Fixture(body, shape, def) {
  ...
  def = options_optionsjs(def, FixtureDef);
...
Fixture.prototype.setDensity = function(density) {
  _ASSERT && common_assert(Mathjs_isFinite(density) && density >= 0.0);
...
Fixture.prototype.getAABB = function(childIndex) {
  _ASSERT && common_assert(0 <= childIndex && childIndex < this.m_proxyCount);
...
Fixture.prototype.createProxies = function(broadPhase, xf) {
  _ASSERT && common_assert(this.m_proxyCount == 0);
