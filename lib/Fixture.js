...
Fixture.prototype.setDensity = function(density) {
  _ASSERT && utilcommon_assertjs(Mathjs_isFinite(density) && density >= 0.0);
...
Fixture.prototype.getAABB = function(childIndex) {
  _ASSERT && utilcommon_assertjs(0 <= childIndex && childIndex < this.m_proxyCount);
...
Fixture.prototype.createProxies = function(broadPhase, xf) {
  _ASSERT && utilcommon_assertjs(this.m_proxyCount == 0);
