...
Solver.prototype.solveIsland = function (step) {
  ...
  for (var i = 0; i < this.m_bodies.length; ++i) {
    ...
    var c = (0, _Vec.clone)(body.m_sweep.c);
    var a = body.m_sweep.a;
    var v = (0, _Vec.clone)(body.m_linearVelocity);
  ...
  for (var i = 0; i < this.m_bodies.length; ++i) {
    ...
    var c = (0, _Vec.clone)(body.c_position.c);
    var a = body.c_position.a;
    var v = (0, _Vec.clone)(body.c_velocity.v);
    var w = body.c_velocity.w;

    // Check for large velocities
    var translation = (0, _Vec.mul)(h, v);
    if ((0, _Vec.lengthSquared)(translation) > _Settings.maxTranslationSquared) {
  ...
  if (allowSleep) {
    ...
    for (var i = 0; i < this.m_bodies.length; ++i) {
      ...
      if (body.m_autoSleepFlag == false || body.m_angularVelocity * body.m_angularVelocity > angTolSqr || (0, _Vec.lengthSquared)(body.m_linearVelocity) > linTolSqr) {
...
Solver.prototype.solveIslandTOI = function (subStep, toiA, toiB) {
  ...
  for (var i = 0; i < this.m_bodies.length; ++i) {
    ...
    // Check for large velocities
    var translation = (0, _Vec.mul)(h, v);
    if ((0, _Vec.dot)(translation, translation) > _Settings.maxTranslationSquared) {
      var ratio = _Settings.maxTranslation / translation.length();
      v.mul(ratio);
    }
