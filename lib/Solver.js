...
Solver.prototype.addBody = function (body) {
  _ASSERT && (0, _common.commonjs)(body instanceof _Body.Body, 'Not a Body!', body);
...
Solver.prototype.addContact = function (contact) {
  _ASSERT && (0, _common.commonjs)(contact instanceof _Contact.Contact, 'Not a Contact!', contact);
  this.m_contacts.push(contact);
};

Solver.prototype.addJoint = function (joint) {
  _ASSERT && (0, _common.commonjs)(joint instanceof _Joint.Joint, 'Not a Joint!', joint);
...
Solver.prototype.solveWorld = function (step) {
  ...
  for (var seed = world.m_bodyList; seed; seed = seed.m_next) {
    ...
    while (stack.length > 0) {
      ...
      var b = stack.pop();
      _ASSERT && (0, _common.commonjs)(b.isActive() == true);
      this.addBody(b);
...
Solver.prototype.solveIsland = function (step) {
  ...
  for (var i = 0; i < this.m_bodies.length; ++i) {
    ...
    if (rotation * rotation > _Settings.maxRotationSquared) {
      var ratio = _Settings.maxRotation / commonMath_mathjs.abs(rotation);
      w *= ratio;
    }
...
Solver.prototype.printBodies = function (tag) {
  for (var i = 0; i < this.m_bodies.length; ++i) {
    var b = this.m_bodies[i];
    (0, _common.commonjs)(tag, b.c_position.a, b.c_position.c.x, b.c_position.c.y, b.c_velocity.w, b.c_velocity.v.x, b.c_velocity.v.y);
  }
};
  ...
  for (;;) {
    ...
    for (var c = world.m_contactList; c; c = c.m_next) {
      ...
      if (c.m_toiFlag) {
        ...
        _ASSERT && (0, _common.commonjs)(bA.isDynamic() || bB.isDynamic());
        ...
        _ASSERT && (0, _common.commonjs)(alpha0 < 1.0);
