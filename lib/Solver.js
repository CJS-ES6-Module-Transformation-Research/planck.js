...
Solver.prototype.addBody = function(body) {
  _ASSERT && common_debug.assert(body instanceof Body_Body, 'Not a Body!', body);
...
Solver.prototype.addContact = function(contact) {
  _ASSERT && common_debug.assert(contact instanceof Contact_Contact, 'Not a Contact!', contact);
  this.m_contacts.push(contact);
};

Solver.prototype.addJoint = function(joint) {
  _ASSERT && common_debug.assert(joint instanceof Joint_Joint, 'Not a Joint!', joint);
...
Solver.prototype.solveWorld = function(step) {
  ...
  for (var seed = world.m_bodyList; seed; seed = seed.m_next) {
    ...
    while (stack.length > 0) {
      ...
      var b = stack.pop();
      _ASSERT && common_debug.assert(b.isActive() == true);
      this.addBody(b);
...
Solver.prototype.printBodies = function(tag) {
  for (var i = 0; i < this.m_bodies.length; ++i) {
    var b = this.m_bodies[i];
    common_debug(tag, b.c_position.a, b.c_position.c.x, b.c_position.c.y, b.c_velocity.w, b.c_velocity.v.x, b.c_velocity.v.y);
  }
};
  ...
  for (;;) {
    ...
    for (var c = world.m_contactList; c; c = c.m_next) {
      ...
      if (c.m_toiFlag) {
        ...
        _ASSERT && common_debug.assert(bA.isDynamic() || bB.isDynamic());
        ...
        _ASSERT && common_debug.assert(alpha0 < 1.0);
