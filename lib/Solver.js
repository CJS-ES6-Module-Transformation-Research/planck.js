...
Solver.prototype.addBody = function(body) {
  _ASSERT && common_assert(body instanceof Body_Body, 'Not a Body!', body);
...
Solver.prototype.addContact = function(contact) {
  _ASSERT && common_assert(contact instanceof Contact_Contact, 'Not a Contact!', contact);
  this.m_contacts.push(contact);
};

Solver.prototype.addJoint = function(joint) {
  _ASSERT && common_assert(joint instanceof Joint_Joint, 'Not a Joint!', joint);
...
Solver.prototype.solveWorld = function(step) {
  ...
  for (var seed = world.m_bodyList; seed; seed = seed.m_next) {
    ...
    while (stack.length > 0) {
      ...
      var b = stack.pop();
      _ASSERT && common_assert(b.isActive() == true);
      this.addBody(b);
  ...
  for (;;) {
    ...
    for (var c = world.m_contactList; c; c = c.m_next) {
      ...
      if (c.m_toiFlag) {
        ...
        _ASSERT && common_assert(bA.isDynamic() || bB.isDynamic());
        ...
        _ASSERT && common_assert(alpha0 < 1.0);
