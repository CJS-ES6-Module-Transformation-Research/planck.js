...
MotorJoint._super = _Joint2.default;
MotorJoint.prototype = (0, _create2.default)(MotorJoint._super.prototype);
...
MotorJoint.prototype.setCorrectionFactor = function (factor) {
  _ASSERT && common.assert(_Math2.default.isFinite(factor) && 0.0 <= factor && factor <= 1.0);
...
MotorJoint.prototype.initVelocityConstraints = function (step) {
  ...
  this.m_rA = _Rot2.default.mulVec2(qA, _Vec2.default.neg(this.m_localCenterA));
  this.m_rB = _Rot2.default.mulVec2(qB, _Vec2.default.neg(this.m_localCenterB));
  ...
  this.m_linearError = _Vec2.default.zero();
  this.m_linearError.addCombine(1, cB, 1, this.m_rB);
  this.m_linearError.subCombine(1, cA, 1, this.m_rA);
  this.m_linearError.sub(_Rot2.default.mulVec2(qA, this.m_linearOffset));
...
MotorJoint.prototype.solveVelocityConstraints = function (step) {
  ...
  // Solve linear friction
  {
    ...
    var impulse = _Vec2.default.neg(_Mat2.default.mulVec2(this.m_linearMass, Cdot));
    var oldImpulse = _Vec2.default.clone(this.m_linearImpulse);
