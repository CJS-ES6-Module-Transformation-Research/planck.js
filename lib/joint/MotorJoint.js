...
MotorJoint__super = Joint_Joint;;
MotorJoint.prototype = create_createjs(MotorJoint__super.prototype);
...
MotorJoint.prototype.setMaxForce = function(force) {
  _ASSERT && common_assert(Mathjs_isFinite(force) && force >= 0.0);
...
MotorJoint.prototype.setMaxTorque = function(torque) {
  _ASSERT && common_assert(Mathjs_isFinite(torque) && torque >= 0.0);
...
MotorJoint.prototype.setCorrectionFactor = function(factor) {
  _ASSERT && common_assert(Mathjs_isFinite(factor) && 0.0 <= factor && factor <= 1.0);
