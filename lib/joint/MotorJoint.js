...
MotorJoint__super = Joint;
MotorJoint.prototype = create(MotorJoint__super.prototype);
...
MotorJoint.prototype.setMaxForce = function(force) {
  _ASSERT && common(Mathjs_isFinite(force) && force >= 0.0);
...
MotorJoint.prototype.setMaxTorque = function(torque) {
  _ASSERT && common(Mathjs_isFinite(torque) && torque >= 0.0);
...
MotorJoint.prototype.setCorrectionFactor = function(factor) {
  _ASSERT && common(Mathjs_isFinite(factor) && 0.0 <= factor && factor <= 1.0);
