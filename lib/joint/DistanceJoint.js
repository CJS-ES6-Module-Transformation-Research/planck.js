import { optionsjs as DistanceJoint_options } from "../util/options";
import { createjs as DistanceJoint_create } from "../util/create";

import {
  math as DistanceJoint_Math,
...
DistanceJoint.prototype = DistanceJoint_create(DistanceJoint__super.prototype);
...
function DistanceJoint(def, bodyA, bodyB, anchorA, anchorB) {
  ...
  def = DistanceJoint_options(def, DEFAULTS);
  DistanceJoint_Joint.call(this, def, bodyA, bodyB);
  bodyA = this.m_bodyA;
  bodyB = this.m_bodyB;
...
DistanceJoint.prototype.solvePositionConstraints = function(step) {
  ...
  var C = length - this.m_length;
  C = Mathjs_clamp(C, -Settings.maxLinearCorrection, Settings.maxLinearCorrection);
