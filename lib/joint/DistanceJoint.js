...
DistanceJoint__super = _Joint.Joint;;
DistanceJoint.prototype = (0, _create.createjs)(DistanceJoint__super.prototype);
...
function DistanceJoint(def, bodyA, bodyB, anchorA, anchorB) {
  ...
  // Solver shared
  this.m_localAnchorA = anchorA ? bodyA.getLocalPoint(anchorA) : def.localAnchorA || (0, _Vec.zero)();
  this.m_localAnchorB = anchorB ? bodyB.getLocalPoint(anchorB) : def.localAnchorB || (0, _Vec.zero)();
  this.m_length = (0, _Math.isFinite)(def.length) ? def.length : (0, _Vec.distance)(bodyA.getWorldPoint(this.m_localAnchorA), bodyB.getWorldPoint(this.m_localAnchorB));
...
DistanceJoint.prototype.initVelocityConstraints = function (step) {
  ...
  this.m_u = (0, _Vec.sub)((0, _Vec.add)(cB, this.m_rB), (0, _Vec.add)(cA, this.m_rA));
  ...
  var crAu = (0, _Vec.cross)(this.m_rA, this.m_u);
  var crBu = (0, _Vec.cross)(this.m_rB, this.m_u);
...
DistanceJoint.prototype.solveVelocityConstraints = function (step) {
  ...
  var Cdot = (0, _Vec.dot)(this.m_u, vpB) - (0, _Vec.dot)(this.m_u, vpA);

  var impulse = -this.m_mass * (Cdot + this.m_bias + this.m_gamma * this.m_impulse);
  this.m_impulse += impulse;

  var P = (0, _Vec.mul)(impulse, this.m_u);
  vA.subMul(this.m_invMassA, P);
  wA -= this.m_invIA * (0, _Vec.cross)(this.m_rA, P);
  vB.addMul(this.m_invMassB, P);
  wB += this.m_invIB * (0, _Vec.cross)(this.m_rB, P);
...
DistanceJoint.prototype.solvePositionConstraints = function (step) {
  ...
  var u = (0, _Vec.sub)((0, _Vec.add)(cB, rB), (0, _Vec.add)(cA, rA));
