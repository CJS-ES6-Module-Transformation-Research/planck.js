import { assert as PulleyJoint_assert } from "../util/common";
import { optionsjs as PulleyJoint_optionsjs } from "../util/options";
import { createjs as PulleyJoint_createjs } from "../util/create";
...
PulleyJoint.prototype = PulleyJoint_createjs(PulleyJoint__super.prototype);
...
function PulleyJoint(def, bodyA, bodyB, groundA, groundB, anchorA, anchorB, ratio) {
  ...
  def = PulleyJoint_optionsjs(def, PulleyJointDef);
  ...
  _ASSERT && PulleyJoint_assert(ratio > Mathjs_EPSILON);
