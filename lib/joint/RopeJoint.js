...
RopeJoint.prototype.initVelocityConstraints = function(step) {
  ...
  if (this.m_length > Settings_Settingsjs.linearSlop) {
...
RopeJoint.prototype.solvePositionConstraints = function(step) {
  ...
  C = commonMath_mathjs.clamp(C, 0.0, Settings_Settingsjs.maxLinearCorrection);
  ...
  return length - this.m_maxLength < Settings_Settingsjs.linearSlop;
}
