...
RopeJoint._super = _Joint2.default;
RopeJoint.prototype = (0, _create2.default)(RopeJoint._super.prototype);
...
function RopeJoint(def, bodyA, bodyB, anchor) {
  ...
  this.m_localAnchorA = anchor ? bodyA.getLocalPoint(anchor) : def.localAnchorA || _Vec2.default.neo(-1.0, 0.0);
  this.m_localAnchorB = anchor ? bodyB.getLocalPoint(anchor) : def.localAnchorB || _Vec2.default.neo(1.0, 0.0);
...
RopeJoint.prototype.initVelocityConstraints = function (step) {
  ...
  this.m_rA = _Rot2.default.mulSub(qA, this.m_localAnchorA, this.m_localCenterA);
  this.m_rB = _Rot2.default.mulSub(qB, this.m_localAnchorB, this.m_localCenterB);
  this.m_u = _Vec2.default.zero();
  ...
  if (this.m_length > _Settings2.default.linearSlop) {
  ...
  var crA = _Vec2.default.cross(this.m_rA, this.m_u); // float
  var crB = _Vec2.default.cross(this.m_rB, this.m_u); // float
...
RopeJoint.prototype.solveVelocityConstraints = function (step) {
  ...
  var vpA = _Vec2.default.addCross(vA, wA, this.m_rA); // Vec2
  var vpB = _Vec2.default.addCross(vB, wB, this.m_rB); // Vec2
  var C = this.m_length - this.m_maxLength; // float
  var Cdot = _Vec2.default.dot(this.m_u, _Vec2.default.sub(vpB, vpA)); // float
  ...
  this.m_impulse = _Math2.default.min(0.0, this.m_impulse + impulse);
  impulse = this.m_impulse - oldImpulse;

  var P = _Vec2.default.mul(impulse, this.m_u); // Vec2
  vA.subMul(this.m_invMassA, P);
  wA -= this.m_invIA * _Vec2.default.cross(this.m_rA, P);
  vB.addMul(this.m_invMassB, P);
  wB += this.m_invIB * _Vec2.default.cross(this.m_rB, P);
...
RopeJoint.prototype.solvePositionConstraints = function (step) {
  ...
  C = _Math2.default.clamp(C, 0.0, _Settings2.default.maxLinearCorrection);

  var impulse = -this.m_mass * C; // float
  var P = _Vec2.default.mul(impulse, u); // Vec2
  ...
  return length - this.m_maxLength < _Settings2.default.linearSlop;
};
