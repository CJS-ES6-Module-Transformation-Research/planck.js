import { assert as FrictionJoint_assert } from "../util/common";
import { optionsjs as FrictionJoint_optionsjs } from "../util/options";
import { createjs as FrictionJoint_createjs } from "../util/create";
...
FrictionJoint.prototype = FrictionJoint_createjs(FrictionJoint__super.prototype);
...
function FrictionJoint(def, bodyA, bodyB, anchor) {
  ...
  def = FrictionJoint_optionsjs(def, DEFAULTS);
...
FrictionJoint.prototype.setMaxForce = function(force) {
  _ASSERT && FrictionJoint_assert(Mathjs_isFinite(force) && force >= 0.0);
...
FrictionJoint.prototype.setMaxTorque = function(torque) {
  _ASSERT && FrictionJoint_assert(Mathjs_isFinite(torque) && torque >= 0.0);
