...
FrictionJoint__super = _Joint.Joint;;
FrictionJoint.prototype = (0, _create.createjs)(FrictionJoint__super.prototype);
...
FrictionJoint.prototype.solveVelocityConstraints = function (step) {
  ...
  {
    var Cdot = (0, _Vec.sub)((0, _Vec.add)(vB, (0, _Vec.cross)(wB, this.m_rB)), (0, _Vec.add)(vA, (0, _Vec.cross)(wA, this.m_rA))); // Vec2

    var impulse = (0, _Vec.neg)(_Mat.Mat22.mulVec2(this.m_linearMass, Cdot)); // Vec2
