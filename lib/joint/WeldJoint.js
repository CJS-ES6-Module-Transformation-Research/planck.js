...
WeldJoint._super = _Joint2.default;
WeldJoint.prototype = (0, _create2.default)(WeldJoint._super.prototype);
...
WeldJoint.prototype.initVelocityConstraints = function (step) {
  ...
  if (step.warmStarting) {
    ...
    vA.subMul(mA, P);
    wA -= iA * (_Vec2.default.cross(this.m_rA, P) + this.m_impulse.z);

    vB.addMul(mB, P);
    wB += iB * (_Vec2.default.cross(this.m_rB, P) + this.m_impulse.z);
  } else {
...
WeldJoint.prototype.solveVelocityConstraints = function (step) {
  ...
  if (this.m_frequencyHz > 0.0) {
    ...
    Cdot1.subCombine(1, vA, 1, _Vec2.default.cross(wA, this.m_rA)); // Vec2

    var impulse1 = _Vec2.default.neg(_Mat4.default.mulVec2(this.m_mass, Cdot1)); // Vec2
    this.m_impulse.x += impulse1.x;
    this.m_impulse.y += impulse1.y;

    var P = _Vec2.default.clone(impulse1); // Vec2

    vA.subMul(mA, P);
    wA -= iA * _Vec2.default.cross(this.m_rA, P);

    vB.addMul(mB, P);
    wB += iB * _Vec2.default.cross(this.m_rB, P);
  } else {
    var Cdot1 = _Vec2.default.zero();
    Cdot1.addCombine(1, vB, 1, _Vec2.default.cross(wB, this.m_rB));
    Cdot1.subCombine(1, vA, 1, _Vec2.default.cross(wA, this.m_rA)); // Vec2
    var Cdot2 = wB - wA; // float
    var Cdot = (0, _Vec4.default)(Cdot1.x, Cdot1.y, Cdot2); // Vec3

    var impulse = _Vec4.default.neg(_Mat4.default.mulVec3(this.m_mass, Cdot)); // Vec3
...
WeldJoint.prototype.solvePositionConstraints = function (step) {
  ...
  if (this.m_frequencyHz > 0.0) {
    ...
    var P = _Vec2.default.neg(K.solve22(C1)); // Vec2
    ...
    positionError = C1.length();
    angularError = _Math2.default.abs(C2);

    var C = (0, _Vec4.default)(C1.x, C1.y, C2);

    var impulse = (0, _Vec4.default)();
    if (K.ez.z > 0.0) {
      impulse = _Vec4.default.neg(K.solve33(C));
    } else {
      var impulse2 = _Vec2.default.neg(K.solve22(C1));
    ...
    cA.subMul(mA, P);
    aA -= iA * (_Vec2.default.cross(rA, P) + impulse.z);

    cB.addMul(mB, P);
    aB += iB * (_Vec2.default.cross(rB, P) + impulse.z);
  }
