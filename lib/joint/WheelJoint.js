...
WheelJoint._super = _Joint2.default;
WheelJoint.prototype = (0, _create2.default)(WheelJoint._super.prototype);
...
function WheelJoint(def, bodyA, bodyB, anchor, axis) {
  ...
  this.m_localAxis = axis ? bodyA.getLocalVector(axis) : def.localAxisA || _Vec2.default.neo(1.0, 0.0);
  ...
  this.m_ax = _Vec2.default.zero();
  this.m_ay = _Vec2.default.zero(); // Vec2
  this.m_sAx;
  this.m_sBx; // float
  this.m_sAy;
  this.m_sBy; // float
...
WheelJoint.prototype.getJointTranslation = function () {
  ...
  var d = _Vec2.default.sub(pB, pA); // Vec2
  var axis = bA.getWorldVector(this.m_localXAxisA); // Vec2

  var translation = _Vec2.default.dot(d, axis); // float
  return translation;
};
...
WheelJoint.prototype.getReactionForce = function (inv_dt) {
  return _Vec2.default.combine(this.m_impulse, this.m_ay, this.m_springImpulse, this.m_ax).mul(inv_dt);
};
...
WheelJoint.prototype.initVelocityConstraints = function (step) {
  ...
  {
    this.m_ay = _Rot2.default.mulVec2(qA, this.m_localYAxisA);
    this.m_sAy = _Vec2.default.cross(_Vec2.default.add(d, rA), this.m_ay);
    this.m_sBy = _Vec2.default.cross(rB, this.m_ay);
  ...
  if (this.m_frequencyHz > 0.0) {
    this.m_ax = _Rot2.default.mulVec2(qA, this.m_localXAxisA);
    this.m_sAx = _Vec2.default.cross(_Vec2.default.add(d, rA), this.m_ax);
    this.m_sBx = _Vec2.default.cross(rB, this.m_ax);
    ...
    if (invMass > 0.0) {
      ...
      var C = _Vec2.default.dot(d, this.m_ax); // float

      // Frequency
      var omega = 2.0 * _Math2.default.PI * this.m_frequencyHz; // float
  ...
  if (step.warmStarting) {
    ...
    var P = _Vec2.default.combine(this.m_impulse, this.m_ay, this.m_springImpulse, this.m_ax);
...
WheelJoint.prototype.solveVelocityConstraints = function (step) {
  ...
  {
    var Cdot = _Vec2.default.dot(this.m_ax, vB) - _Vec2.default.dot(this.m_ax, vA) + this.m_sBx * wB - this.m_sAx * wA; // float
    var impulse = -this.m_springMass * (Cdot + this.m_bias + this.m_gamma * this.m_springImpulse); // float
    this.m_springImpulse += impulse;

    var P = _Vec2.default.mul(impulse, this.m_ax); // Vec2
  ...
  {
    var Cdot = _Vec2.default.dot(this.m_ay, vB) - _Vec2.default.dot(this.m_ay, vA) + this.m_sBy * wB - this.m_sAy * wA; // float
    var impulse = -this.m_mass * Cdot; // float
    this.m_impulse += impulse;

    var P = _Vec2.default.mul(impulse, this.m_ay); // Vec2
...
WheelJoint.prototype.solvePositionConstraints = function (step) {
  ...
  var ay = _Rot2.default.mulVec2(qA, this.m_localYAxisA);

  var sAy = _Vec2.default.cross(_Vec2.default.add(d, rA), ay); // float
  var sBy = _Vec2.default.cross(rB, ay); // float

  var C = _Vec2.default.dot(d, ay); // float
  ...
  var P = _Vec2.default.mul(impulse, ay); // Vec2
