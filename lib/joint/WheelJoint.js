...
WheelJoint__super = _Joint.Joint;;
WheelJoint.prototype = (0, _create.createjs)(WheelJoint__super.prototype);
...
function WheelJoint(def, bodyA, bodyB, anchor, axis) {
  ...
  this.m_localAxis = axis ? bodyA.getLocalVector(axis) : def.localAxisA || (0, _Vec.neo)(1.0, 0.0);
  ...
  this.m_ax = (0, _Vec.zero)();
  this.m_ay = (0, _Vec.zero)(); // Vec2
  this.m_sAx;
  this.m_sBx; // float
  this.m_sAy;
  this.m_sBy; // float
...
WheelJoint.prototype.getJointTranslation = function () {
  ...
  var d = (0, _Vec.sub)(pB, pA); // Vec2
  var axis = bA.getWorldVector(this.m_localXAxisA); // Vec2

  var translation = (0, _Vec.dot)(d, axis); // float
  return translation;
};
...
WheelJoint.prototype.getReactionForce = function (inv_dt) {
  return (0, _Vec.combine)(this.m_impulse, this.m_ay, this.m_springImpulse, this.m_ax).mul(inv_dt);
};
...
WheelJoint.prototype.initVelocityConstraints = function (step) {
  ...
  {
    this.m_ay = (0, _Rot.mulVec2)(qA, this.m_localYAxisA);
    this.m_sAy = (0, _Vec.cross)((0, _Vec.add)(d, rA), this.m_ay);
    this.m_sBy = (0, _Vec.cross)(rB, this.m_ay);
  ...
  if (this.m_frequencyHz > 0.0) {
    this.m_ax = (0, _Rot.mulVec2)(qA, this.m_localXAxisA);
    this.m_sAx = (0, _Vec.cross)((0, _Vec.add)(d, rA), this.m_ax);
    this.m_sBx = (0, _Vec.cross)(rB, this.m_ax);
    ...
    if (invMass > 0.0) {
      ...
      var C = (0, _Vec.dot)(d, this.m_ax); // float
  ...
  if (step.warmStarting) {
    ...
    var P = (0, _Vec.combine)(this.m_impulse, this.m_ay, this.m_springImpulse, this.m_ax);
...
WheelJoint.prototype.solveVelocityConstraints = function (step) {
  ...
  {
    var Cdot = (0, _Vec.dot)(this.m_ax, vB) - (0, _Vec.dot)(this.m_ax, vA) + this.m_sBx * wB - this.m_sAx * wA; // float
    var impulse = -this.m_springMass * (Cdot + this.m_bias + this.m_gamma * this.m_springImpulse); // float
    this.m_springImpulse += impulse;

    var P = (0, _Vec.mul)(impulse, this.m_ax); // Vec2
  ...
  {
    var Cdot = (0, _Vec.dot)(this.m_ay, vB) - (0, _Vec.dot)(this.m_ay, vA) + this.m_sBy * wB - this.m_sAy * wA; // float
    var impulse = -this.m_mass * Cdot; // float
    this.m_impulse += impulse;

    var P = (0, _Vec.mul)(impulse, this.m_ay); // Vec2
...
WheelJoint.prototype.solvePositionConstraints = function (step) {
  ...
  var ay = (0, _Rot.mulVec2)(qA, this.m_localYAxisA);

  var sAy = (0, _Vec.cross)((0, _Vec.add)(d, rA), ay); // float
  var sBy = (0, _Vec.cross)(rB, ay); // float

  var C = (0, _Vec.dot)(d, ay); // float
  ...
  var P = (0, _Vec.mul)(impulse, ay); // Vec2
  ...
  return Math.abs(C) <= _Settings.linearSlop;
};
