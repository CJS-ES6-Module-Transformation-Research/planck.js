var WheelJoint_WheelJoint = WheelJoint;
...
WheelJoint._super = Joint_Jointjs;
WheelJoint.prototype = utilcreate_createjsjs(WheelJoint._super.prototype);
...
function WheelJoint(def, bodyA, bodyB, anchor, axis) {
  ...
  this.m_localAxis = axis ? bodyA.getLocalVector(axis) : def.localAxisA || commonVec2_Vec2js.neo(1.0, 0.0);
  ...
  this.m_ax = commonVec2_Vec2js.zero();
  this.m_ay = commonVec2_Vec2js.zero(); // Vec2
  this.m_sAx;
  this.m_sBx; // float
  this.m_sAy;
  this.m_sBy; // float
...
WheelJoint.prototype.getJointTranslation = function() {
  ...
  var d = commonVec2_Vec2js.sub(pB, pA); // Vec2
  var axis = bA.getWorldVector(this.m_localXAxisA); // Vec2

  var translation = commonVec2_Vec2js.dot(d, axis); // float
  return translation;
}
...
WheelJoint.prototype.getReactionForce = function(inv_dt) {
  return commonVec2_Vec2js.combine(this.m_impulse, this.m_ay, this.m_springImpulse, this.m_ax).mul(inv_dt);
}
...
WheelJoint.prototype.initVelocityConstraints = function(step) {
  ...
  {
    this.m_ay = commonRot_Rotjs.mulVec2(qA, this.m_localYAxisA);
    this.m_sAy = commonVec2_Vec2js.cross(commonVec2_Vec2js.add(d, rA), this.m_ay);
    this.m_sBy = commonVec2_Vec2js.cross(rB, this.m_ay);
  ...
  if (this.m_frequencyHz > 0.0) {
    this.m_ax = commonRot_Rotjs.mulVec2(qA, this.m_localXAxisA);
    this.m_sAx = commonVec2_Vec2js.cross(commonVec2_Vec2js.add(d, rA), this.m_ax);
    this.m_sBx = commonVec2_Vec2js.cross(rB, this.m_ax);
    ...
    if (invMass > 0.0) {
      ...
      var C = commonVec2_Vec2js.dot(d, this.m_ax); // float
  ...
  if (step.warmStarting) {
    ...
    var P = commonVec2_Vec2js.combine(this.m_impulse, this.m_ay, this.m_springImpulse, this.m_ax);
...
WheelJoint.prototype.solveVelocityConstraints = function(step) {
  ...
  {
    var Cdot = commonVec2_Vec2js.dot(this.m_ax, vB) - commonVec2_Vec2js.dot(this.m_ax, vA) + this.m_sBx
        * wB - this.m_sAx * wA; // float
    var impulse = -this.m_springMass
        * (Cdot + this.m_bias + this.m_gamma * this.m_springImpulse); // float
    this.m_springImpulse += impulse;

    var P = commonVec2_Vec2js.mul(impulse, this.m_ax); // Vec2
  ...
  {
    var Cdot = commonVec2_Vec2js.dot(this.m_ay, vB) - commonVec2_Vec2js.dot(this.m_ay, vA) + this.m_sBy
        * wB - this.m_sAy * wA; // float
    var impulse = -this.m_mass * Cdot; // float
    this.m_impulse += impulse;

    var P = commonVec2_Vec2js.mul(impulse, this.m_ay); // Vec2
...
WheelJoint.prototype.solvePositionConstraints = function(step) {
  ...
  var ay = commonRot_Rotjs.mulVec2(qA, this.m_localYAxisA);

  var sAy = commonVec2_Vec2js.cross(commonVec2_Vec2js.add(d, rA), ay); // float
  var sBy = commonVec2_Vec2js.cross(rB, ay); // float

  var C = commonVec2_Vec2js.dot(d, ay); // float
  ...
  var P = commonVec2_Vec2js.mul(impulse, ay); // Vec2
  ...
  return commonMath_mathjs.abs(C) <= Settings_Settingsjs.linearSlop;
}
