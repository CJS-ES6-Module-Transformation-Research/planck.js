import { assert as MouseJoint_assert } from "../util/common";
import { optionsjs as MouseJoint_optionsjs } from "../util/options";
import { createjs as MouseJoint_createjs } from "../util/create";
...
MouseJoint.prototype = MouseJoint_createjs(MouseJoint__super.prototype);
...
function MouseJoint(def, bodyA, bodyB, target) {
  ...
  def = MouseJoint_optionsjs(def, DEFAULTS);
  ...
  _ASSERT && MouseJoint_assert(Mathjs_isFinite(def.maxForce) && def.maxForce >= 0.0);
  _ASSERT && MouseJoint_assert(Mathjs_isFinite(def.frequencyHz) && def.frequencyHz >= 0.0);
  _ASSERT && MouseJoint_assert(Mathjs_isFinite(def.dampingRatio) && def.dampingRatio >= 0.0);
...
MouseJoint.prototype.initVelocityConstraints = function(step) {
  ...
  var h = step.dt;
  _ASSERT && MouseJoint_assert(d + h * k > Mathjs_EPSILON);
