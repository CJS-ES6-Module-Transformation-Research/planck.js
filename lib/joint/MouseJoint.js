...
function MouseJoint(def, bodyA, bodyB, target) {
  ...
  _ASSERT && common.assert((0, _Math.isFinite)(def.maxForce) && def.maxForce >= 0.0);
  _ASSERT && common.assert((0, _Math.isFinite)(def.frequencyHz) && def.frequencyHz >= 0.0);
  _ASSERT && common.assert((0, _Math.isFinite)(def.dampingRatio) && def.dampingRatio >= 0.0);
...
MouseJoint.prototype.initVelocityConstraints = function (step) {
  ...
  var h = step.dt;
  _ASSERT && common.assert(d + h * k > _Math.EPSILON);
