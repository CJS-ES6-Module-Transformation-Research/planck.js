...
MouseJoint__super = Joint_Joint;;
MouseJoint.prototype = create_createjs(MouseJoint__super.prototype);
...
function MouseJoint(def, bodyA, bodyB, target) {
  ...
  _ASSERT && common_assert(Mathjs_isFinite(def.maxForce) && def.maxForce >= 0.0);
  _ASSERT && common_assert(Mathjs_isFinite(def.frequencyHz) && def.frequencyHz >= 0.0);
  _ASSERT && common_assert(Mathjs_isFinite(def.dampingRatio) && def.dampingRatio >= 0.0);
  ...
  this.m_invMassB = 0.0;
  this.m_invIB = 0.0;
  this.mass = new MouseJoint_Mat22()
...
MouseJoint.prototype.initVelocityConstraints = function(step) {
  ...
  var h = step.dt;
  _ASSERT && common_assert(d + h * k > Mathjs_EPSILON);
