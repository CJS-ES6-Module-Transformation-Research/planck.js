...
import { Transform, mulTVec2 as Transformjs_mulTVec2 } from "../common/Transform";
...
MouseJoint__super = Joint;
MouseJoint.prototype = create(MouseJoint__super.prototype);
...
function MouseJoint(def, bodyA, bodyB, target) {
  ...
  _ASSERT && common(Mathjs_isFinite(def.maxForce) && def.maxForce >= 0.0);
  _ASSERT && common(Mathjs_isFinite(def.frequencyHz) && def.frequencyHz >= 0.0);
  _ASSERT && common(Mathjs_isFinite(def.dampingRatio) && def.dampingRatio >= 0.0);
...
MouseJoint.prototype.initVelocityConstraints = function(step) {
  ...
  var h = step.dt;
  _ASSERT && common(d + h * k > Mathjs_EPSILON);
