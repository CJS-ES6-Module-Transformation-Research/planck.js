...
function MouseJoint(def, bodyA, bodyB, target) {
  ...
  _ASSERT && MouseJoint_common.assert(Mathjs_isFinite(def.maxForce) && def.maxForce >= 0.0);
  _ASSERT && MouseJoint_common.assert(Mathjs_isFinite(def.frequencyHz) && def.frequencyHz >= 0.0);
  _ASSERT && MouseJoint_common.assert(Mathjs_isFinite(def.dampingRatio) && def.dampingRatio >= 0.0);
...
MouseJoint.prototype.initVelocityConstraints = function(step) {
  ...
  var h = step.dt;
  _ASSERT && MouseJoint_common.assert(d + h * k > Mathjs_EPSILON);
...
MouseJoint.prototype.solveVelocityConstraints = function(step) {
  ...
  var impulse = MouseJoint_Mat22.mulVec2(this.m_mass, Cdot);
